...
export interface PluginCmccActivityLog extends Struct.CollectionTypeSchema {
...
export interface PluginCmccQueueItem extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private
    dateGmt: Schema.Attribute.DateTime
...
export interface PluginCmccSettings extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private
    duplicateDetection: Schema.Attribute.Boolean &
    ...
    > &
      Schema.Attribute.Private
    maxLinks: Schema.Attribute.Integer & Schema.Attribute.DefaultTo<5>
    moderationBehavior: Schema.Attribute.Enumeration<
      ['flag', 'spam', 'discard']
    > &
      Schema.Attribute.DefaultTo<'flag'>
    notifyOnSpam: Schema.Attribute.Boolean & Schema.Attribute.DefaultTo<true>
    publishedAt: Schema.Attribute.DateTime
    updatedAt: Schema.Attribute.DateTime
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private
